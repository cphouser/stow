...
(defgroup spacemax-theme nil
  "Spacemax-theme options."
  :group 'faces)

(defcustom spacemax-theme-comment-bg nil
  "Don't use a background for comment lines."
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-comment-italic nil
  "Enable italics for comments and also disable background."
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-keyword-italic nil
  "Enable italics for keywords."
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-org-agenda-height nil
...
(defcustom spacemax-theme-org-height t
  "Use varying text heights for org headings."
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-org-bold t
  "Inherit text bold for org headings"
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-org-priority-bold t
  "Inherit text bold for priority items in agenda view"
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-org-highlight nil
  "Highlight org headings."
  :type 'boolean
  :group 'spacemax-theme)

(defcustom spacemax-theme-custom-colors nil
  "Specify a list of custom colors."
  :type 'alist
  :group 'spacemax-theme)

(defcustom spacemax-theme-underline-parens nil
...
(defun custom-colors-override ()
  (mapcar (lambda (x) (list (car x) (cdr x)))
          spacemax-theme-custom-colors))

(defun create-spacemax-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
    ;;                                                          GUI       TER                           GUI       TER
    ;; generic
    (act1          (if (eq variant 'dark) (if (true-color-p) "#222226" "#808080") (if (true-color-p) "#e7e5eb" "#d7dfff")))
    (act2          (if (eq variant 'dark) (if (true-color-p) "#5d4d7a" "cyan") (if (true-color-p) "#d3d3e7" "#afafd7")))
    (base          (if (eq variant 'dark) (if (true-color-p) "#b2b2b2" "#ffffff") (if (true-color-p) "#655370" "#5f5f87")))
    ...
    (const         (if (eq variant 'dark) (if (true-color-p) "#a45bad" "#ffaf5f") (if (true-color-p) "#4e3163" "#8700af")))
    (comment       (if (eq variant 'dark) (if (true-color-p) "#2aa1ae" "brightblack") (if (true-color-p) "#2aa1ae" "#008787")))
    (comment-light (if (eq variant 'dark) (if (true-color-p) "#2aa1ae" "color-54") (if (true-color-p) "#a49da5" "#008787")))
    ...
    (err           (if (eq variant 'dark) (if (true-color-p) "#e0211d" "#ff005f") (if (true-color-p) "#e0211d" "#e0211d")))
    (func          (if (eq variant 'dark) (if (true-color-p) "#bc6ec5" "#00d7d7") (if (true-color-p) "#6c3163" "#8700af")))
    (head1         (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "brightgreen") (if (true-color-p) "#3a81c3" "#268bd2")))
    (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "#262626") (if (true-color-p) "#edf1ed" "#ffffff")))
    (head2         (if (eq variant 'dark) (if (true-color-p) "#2d9574" "#afffff") (if (true-color-p) "#2d9574" "#2aa198")))
    (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#262626") (if (true-color-p) "#edf2e9" "#ffffff")))
    (head3         (if (eq variant 'dark) (if (true-color-p) "#67b11d" "cyan") (if (true-color-p) "#67b11d" "#5faf00")))
    (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#262626") (if (true-color-p) "#edf2e9" "#ffffff")))
    (head4         (if (eq variant 'dark) (if (true-color-p) "#b1951d" "green") (if (true-color-p) "#b1951d" "#875f00")))
    ...
    (keyword       (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "#d700ff") (if (true-color-p) "#3a81c3" "#268bd2")))
    (lnum          (if (eq variant 'dark) (if (true-color-p) "#44505c" "#444444") (if (true-color-p) "#a8a8bf" "#af87af")))
    (mat           (if (eq variant 'dark) (if (true-color-p) "#86dc2f" "#d75f00") (if (true-color-p) "#ba2f59" "#af005f")))
    (meta          (if (eq variant 'dark) (if (true-color-p) "#9f8766" "#008787") (if (true-color-p) "#da8b55" "#df5f5f")))
    (str           (if (eq variant 'dark) (if (true-color-p) "#2d9574" "#ff87af") (if (true-color-p) "#2d9574" "#2aa198")))
    (suc           (if (eq variant 'dark) (if (true-color-p) "#86dc2f" "#00d7d7") (if (true-color-p) "#42ae2c" "#00af00")))
    ...
    (type          (if (eq variant 'dark) (if (true-color-p) "#ce537a" "#d75f00") (if (true-color-p) "#ba2f59" "#af005f")))
    (var           (if (eq variant 'dark) (if (true-color-p) "#7590db" "brightblue") (if (true-color-p) "#715ab1" "#af5fd7")))
    (war           (if (eq variant 'dark) (if (true-color-p) "#dc752f" "#ff8700") (if (true-color-p) "#dc752f" "#dc752f")))
    ...
    (blue          (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "#00d7d7") (if (true-color-p) "#3a81c3" "#268bd2")))
...
;;;;; basics
     ...
     `(font-lock-builtin-face ((,class (:foreground ,head1))))
     `(font-lock-comment-face ((,class (:foreground ,(if spacemax-theme-comment-italic comment-light comment) :background ,(when spacemax-theme-comment-bg comment-bg) :slant ,(if spacemax-theme-comment-italic 'italic 'normal)))))
     `(font-lock-constant-face ((,class (:foreground ,const))))
     `(font-lock-doc-face ((,class (:foreground ,meta))))
     `(font-lock-function-name-face ((,class (:foreground ,func :inherit bold))))
     `(font-lock-keyword-face ((,class (:foreground ,keyword :slant ,(if spacemax-theme-keyword-italic 'italic 'normal)))))
...
;;;;; latex
     ...
     `(font-latex-sectioning-0-face ((,class (:inherit bold :foreground ,head3 :height ,(if spacemax-theme-org-height 1.3 1.0) :background ,(when spacemax-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-1-face ((,class (:inherit bold :foreground ,head4 :height ,(if spacemax-theme-org-height 1.3 1.0) :background ,(when spacemax-theme-org-highlight head4-bg)))))
     `(font-latex-sectioning-2-face ((,class (:inherit bold :foreground ,head1 :height ,(if spacemax-theme-org-height 1.3 1.0) :background ,(when spacemax-theme-org-highlight head1-bg)))))
     `(font-latex-sectioning-3-face ((,class (:inherit bold :foreground ,head2 :height ,(if spacemax-theme-org-height 1.2 1.0) :background ,(when spacemax-theme-org-highlight head2-bg)))))
     `(font-latex-sectioning-4-face ((,class (:bold nil :foreground ,head3 :height ,(if spacemax-theme-org-height 1.1 1.0) :background ,(when spacemax-theme-org-highlight head3-bg)))))
     `(font-latex-sectioning-5-face ((,class (:bold nil :foreground ,head4 :background ,(when spacemax-theme-org-highlight head4-bg)))))
...
;;;;; markdown
     `(markdown-header-face-1 ((,class (:inherit bold :foreground ,head1 :height ,(if spacemax-theme-org-height 1.3 1.0) :background ,(when spacemax-theme-org-highlight head1-bg)))))
     `(markdown-header-face-2 ((,class (:inherit bold :foreground ,head2 :height ,(if spacemax-theme-org-height 1.2 1.0) :background ,(when spacemax-theme-org-highlight head2-bg)))))
     `(markdown-header-face-3 ((,class (:bold nil :foreground ,head3 :height ,(if spacemax-theme-org-height 1.1 1.0) :background ,(when spacemax-theme-org-highlight head3-bg)))))
     `(markdown-header-face-4 ((,class (:bold nil :foreground ,head4 :background ,(when spacemax-theme-org-highlight head4-bg)))))
...
;;;;; mode-line
     ...
     `(mode-line-inactive  ((,class (:foreground ,mat :background ,bg1  :box (:color ,border :line-width 1)))))
...
;;;;; org
     ...
     `(org-agenda-date ((,class (:foreground ,var :height ,(if spacemax-theme-org-agenda-height 1.1 1.0)))))
     `(org-agenda-date-today ((,class (:foreground ,keyword :inherit bold :height ,(if spacemax-theme-org-agenda-height 1.3 1.0)))))
     `(org-agenda-date-weekend ((,class (:inherit bold :foreground ,var))))
     `(org-agenda-done ((,class (:foreground ,suc :height ,(if spacemax-theme-org-agenda-height 1.2 1.0)))))
     ...
     `(org-date ((,class (:foreground ,head1))))
     `(org-date-selected ((,class (:background ,func :foreground ,bg1))))
     `(org-document-info-keyword ((,class (:foreground ,meta))))
     `(org-document-title ((,class (:foreground ,func :inherit bold :height ,(if spacemax-theme-org-height 1.4 1.0) :underline t))))
     ...
     `(org-level-1 ((,class (:inherit bold :bold ,(if spacemax-theme-org-bold 'unspecified nil) :foreground ,head1 :height ,(if spacemax-theme-org-height 1.3 1.0) :background ,(when spacemax-theme-org-highlight head1-bg)))))
     `(org-level-2 ((,class (:inherit bold :bold ,(if spacemax-theme-org-bold 'unspecified nil) :foreground ,head2 :height ,(if spacemax-theme-org-height 1.2 1.0) :background ,(when spacemax-theme-org-highlight head2-bg)))))
     `(org-level-3 ((,class (:bold nil :foreground ,head3 :height ,(if spacemax-theme-org-height 1.1 1.0) :background ,(when spacemax-theme-org-highlight head3-bg)))))
     `(org-level-4 ((,class (:bold nil :foreground ,head4 :background ,(when spacemax-theme-org-highlight head4-bg)))))
     ...
     `(org-priority ((,class (:foreground ,war :inherit bold :bold ,(if spacemax-theme-org-priority-bold 'unspecified nil)))))
     `(org-quote ((,class (:inherit org-block :slant italic))))
     `(org-scheduled ((,class (:foreground ,comp))))
     `(org-scheduled-today ((,class (:foreground ,func :height ,(if spacemax-theme-org-agenda-height 1.2 1.0)))))
...
;;;;; powerline
     `(powerline-active1 ((,class (:background ,act2 :foreground ,bg1 :inherit bold))))
     `(powerline-active2 ((,class (:background ,act2 :foreground ,base))))
     `(powerline-inactive1 ((,class (:background ,bg2 :foreground ,str))))
     `(powerline-inactive2 ((,class (:background ,bg2 :foreground ,base))))

;;;;; rainbow-delimiters
     `(rainbow-delimiters-depth-1-face ((,class :foreground ,head4)))
     `(rainbow-delimiters-depth-2-face ((,class :foreground ,head3)))
     `(rainbow-delimiters-depth-3-face ((,class :foreground ,str)))
     `(rainbow-delimiters-depth-4-face ((,class :foreground ,act1)))
     `(rainbow-delimiters-depth-5-face ((,class :foreground ,head2)))
     `(rainbow-delimiters-depth-6-face ((,class :foreground ,head1)))
     `(rainbow-delimiters-depth-7-face ((,class :foreground ,act1)))
...
;;;;; show-paren
     `(show-paren-match ((,class (:foreground ,mat :inherit bold  :underline ,(when spacemax-theme-underline-parens t)))))
     `(show-paren-match-expression ((,class (:background ,green-bg-s))))
     `(show-paren-mismatch ((,class (:foreground ,err :inherit bold :underline ,(when spacemax-theme-underline-parens t)))))

;;;;; smartparens
     `(sp-pair-overlay-face ((,class (:background ,highlight :foreground nil))))
     `(sp-show-pair-match-face ((,class (:foreground ,mat :inherit bold  :underline ,(when spacemax-theme-underline-parens t)))))
...
(provide 'spacemax-common)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; spacemax-common.el ends here
