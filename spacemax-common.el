...
(defun create-spacemax-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
    ;;                                                          GUI       TER                           GUI       TER
    ;; generic
    (act1          (if (eq variant 'dark) (if (true-color-p) "#222226" "blue") (if (true-color-p) "#e7e5eb" "#d7dfff")))
    (act2          (if (eq variant 'dark) (if (true-color-p) "#5d4d7a" "cyan") (if (true-color-p) "#d3d3e7" "#afafd7")))
    (base          (if (eq variant 'dark) (if (true-color-p) "#b2b2b2" "brightcyan") (if (true-color-p) "#655370" "#5f5f87")))
    (base-dim      (if (eq variant 'dark) (if (true-color-p) "#686868" "#585858") (if (true-color-p) "#a094a2" "#afafd7")))
    (bg1           (if (eq variant 'dark) (if (true-color-p) "#292b2e" "black") (if (true-color-p) "#fbf8ef" "#ffffff")))
    ...
    (const         (if (eq variant 'dark) (if (true-color-p) "#a45bad" "red") (if (true-color-p) "#4e3163" "#8700af")))
    ...
    (err           (if (eq variant 'dark) (if (true-color-p) "#e0211d" "brightred") (if (true-color-p) "#e0211d" "#e0211d")))
    (func          (if (eq variant 'dark) (if (true-color-p) "#bc6ec5" "brightblue") (if (true-color-p) "#6c3163" "#8700af")))
    ...
    (head2         (if (eq variant 'dark) (if (true-color-p) "#2d9574" "brightblue") (if (true-color-p) "#2d9574" "#2aa198")))
    ...
    (keyword       (if (eq variant 'dark) (if (true-color-p) "#4f97d7" "brightyellow") (if (true-color-p) "#3a81c3" "#268bd2")))
    (lnum          (if (eq variant 'dark) (if (true-color-p) "#44505c" "#444444") (if (true-color-p) "#a8a8bf" "#af87af")))
    (mat           (if (eq variant 'dark) (if (true-color-p) "#86dc2f" "brightmagenta") (if (true-color-p) "#ba2f59" "#af005f")))
    (meta          (if (eq variant 'dark) (if (true-color-p) "#9f8766" "blue") (if (true-color-p) "#da8b55" "#df5f5f")))
    (str           (if (eq variant 'dark) (if (true-color-p) "#2d9574" "yellow") (if (true-color-p) "#2d9574" "#2aa198")))
    (suc           (if (eq variant 'dark) (if (true-color-p) "#86dc2f" "color-69") (if (true-color-p) "#42ae2c" "#00af00")))
    ...
    (war           (if (eq variant 'dark) (if (true-color-p) "#dc752f" "color-57") (if (true-color-p) "#dc752f" "#dc752f")))
...
;;;;; basics
     ...
     `(font-lock-keyword-face ((,class (:inherit bold :foreground ,keyword :slant ,(if spacemax-theme-keyword-italic 'italic 'normal)))))
...
;;;;; mode-line
     ...
     `(mode-line-inactive  ((,class (:foreground ,keyword :background ,bg1  :box (:color ,border :line-width 1)))))
